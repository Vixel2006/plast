...
extern "C"
{
    ...
    void plast_cpu_sum_full_reduction_float(const float* input_data, float* output_data,
                                            const size_t* input_shape, size_t input_ndim);
    void plast_cpu_sum_full_reduction_strided_float(const float* input_data, float* output_data,
                                                    const size_t* input_shape, size_t input_ndim,
                                                    const size_t* input_strides);

    void plast_cpu_max_full_reduction_float(const float* input_data, float* output_data,
                                            const size_t* input_shape, size_t input_ndim);
    void plast_cpu_max_full_reduction_strided_float(const float* input_data, float* output_data,
                                                    const size_t* input_shape, size_t input_ndim,
                                                    const size_t* input_strides);
    ...
    void plast_cpu_sum_full_reduction_int32(const int32_t* input_data, int32_t* output_data,
                                            const size_t* input_shape, size_t input_ndim);
    void plast_cpu_sum_full_reduction_strided_int32(const int32_t* input_data, int32_t* output_data,
                                                    const size_t* input_shape, size_t input_ndim,
                                                    const size_t* input_strides);

    void plast_cpu_max_full_reduction_int32(const int32_t* input_data, int32_t* output_data,
                                            const size_t* input_shape, size_t input_ndim);
    void plast_cpu_max_full_reduction_strided_int32(const int32_t* input_data, int32_t* output_data,
                                                    const size_t* input_shape, size_t input_ndim,
                                                    const size_t* input_strides);
    ...
    void plast_cpu_sum_reduction_dim_float(const float* input_data, float* output_data,
                                           const size_t* input_shape, size_t input_ndim,
                                           const size_t* output_shape, size_t output_ndim, int dim);
    void plast_cpu_sum_reduction_dim_strided_float(const float* input_data, float* output_data,
                                                   const size_t* input_shape, size_t input_ndim,
                                                   const size_t* input_strides,
                                                   const size_t* output_shape, size_t output_ndim,
                                                   int dim);
    ...
    void plast_cpu_max_reduction_dim_float(const float* input_data, float* output_data,
                                           const size_t* input_shape, size_t input_ndim,
                                           const size_t* output_shape, size_t output_ndim, int dim);
    void plast_cpu_max_reduction_dim_strided_float(const float* input_data, float* output_data,
                                                   const size_t* input_shape, size_t input_ndim,
                                                   const size_t* input_strides,
                                                   const size_t* output_shape, size_t output_ndim,
                                                   int dim);
    ...
    void plast_cpu_sum_reduction_dim_int32(const int32_t* input_data, int32_t* output_data,
                                           const size_t* input_shape, size_t input_ndim,
                                           const size_t* output_shape, size_t output_ndim, int dim);
    void plast_cpu_sum_reduction_dim_strided_int32(const int32_t* input_data, int32_t* output_data,
                                                   const size_t* input_shape, size_t input_ndim,
                                                   const size_t* input_strides,
                                                   const size_t* output_shape, size_t output_ndim,
                                                   int dim);
    ...
    void plast_cpu_max_reduction_dim_int32(const int32_t* input_data, int32_t* output_data,
                                           const size_t* input_shape, size_t input_ndim,
                                           const size_t* output_shape, size_t output_ndim, int dim);
    void plast_cpu_max_reduction_dim_strided_int32(const int32_t* input_data, int32_t* output_data,
                                                   const size_t* input_shape, size_t input_ndim,
                                                   const size_t* input_strides,
                                                   const size_t* output_shape, size_t output_ndim,
                                                   int dim);
