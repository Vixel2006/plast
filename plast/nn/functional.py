...
def batch_norm(input, running_mean, running_var, weight=None, bias=None, training=True, momentum=0.1, eps=1e-5):
    ...
    if ndim == 2:
        ...
        permuted = input.transpose(0, 1) # [C, N, H, W] (wait, transpose takes 2 axes, so transpose(0, 1) swaps 0 and 1)
        ...
        if training:
            ...
            running_mean.copy_from_numpy((1.0 - momentum) * running_mean.numpy() + momentum * mean_np)
