...
class AdamW(Optimizer):
    def __init__(self, params, lr=0.001, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.01):
        ...
        beta1, beta2 = betas
        self._adamw = AdamW_core(self._opt_arena, persistent_data_arena, lr, beta1, beta2, eps, weight_decay)
    ...
    def step(self):
        for group in self.param_groups:
            ...
            if cuda_params:
                raise NotImplementedError("AdamW CUDA is not implemented in the C engine, please use CPU device")
