...
void div_cpu_backward_float_kernel(const float *dout_data, const u64 *dout_strides,
                                   const u64 *dout_shape, u64 dout_ndim, const float *a_data,
                                   const u64 *a_strides, const u64 *a_shape, u64 a_ndim,
                                   const float *b_data, const u64 *b_strides, const u64 *b_shape,
                                   u64 b_ndim, float *da_data, const u64 *da_strides,
                                   const u64 *da_shape, u64 da_ndim, float *db_data,
                                   const u64 *db_strides, const u64 *db_shape, u64 db_ndim) {
  u64 num_elements = 1;
