...
__global__ void max_cuda_forward_float_contig_kernel(const float *a, float *c, u64 num_elements) {
...
template <u64 block_size>
__global__ void max_cuda_forward_float_noncontig_kernel(const float *a_data, const u64 *a_shape,
...
__global__ void max_cuda_forward_float_dim_contig_kernel(const float *a_data, const u64 *a_shape,
...
__global__ void max_cuda_backward_float_contig_kernel(const float *dc, float *da,
...
__global__ void max_cuda_backward_float_noncontig_kernel(const float *dc, float *da,
                                                         const float *a_data_fwd,
